...
* **การพยากรณ์คะแนนความนิยม (Regression):** แบบจำลอง XGBoost ทำหน้าที่ได้ดีที่สุดโดยให้ค่า $R^2$ Score สูงสุดที่ **0.9692**
...
* `imp_dat.py`: ระบบสกัดและดึงข้อมูลรายวันผ่านโปรแกรมประยุกต์ Spotify Web API (Data Pipeline)
* `clsML.py`: สคริปต์การทำความสะอาดฟีเจอร์, ทำ Sliding Window และประเมินผลกลุ่มโมเดลดั้งเดิม
* `rnnmodel.py`: โครงสร้างการร้อยเลเยอร์ระบบเครือข่ายจำลองพยากรณ์แบบ Multi-task Learning ของ Keras (TensorFlow)
